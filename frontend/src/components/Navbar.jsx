        ...
        <div className='flex items-center justify-between py-5 font-medium' >
            ...
            <div className='flex items-center gap-6'>
                ...
                <div className='group relative'>
                    ...
                    {
                        token && 
                        <div className='hidden group-hover:block absolute bg-white text-black py-3 dropdown-menu right-0 pt-4'>
                ...
                <Link to='/cart' className='relative'>
                    ...
                    <span className='absolute right-[-5px] bottom-[-5px] min-w-5 w-4 text-center leading-4 bg-black text-white aspect-square rounded-full text-[8px]'>{getCartCount()}</span>
                </Link>
